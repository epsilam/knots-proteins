...
class ProteinProjection:
    ...
    def _checkBondCrossing(self, resi1, resi2, resj1, resj2):
    ...
    def plotCrossings(self):
        ...
        lc = mc.LineCollection(lines, linewidths=2, colors=[(0,1,0,1)])
        ...
        lc = mc.LineCollection(lines, linewidths=2, colors=[(0,0,1,1)])
        ax.add_collection(lc)
